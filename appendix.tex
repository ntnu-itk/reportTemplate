...
\lstinputlisting{code/template/plot_constraint.m}\section{Simulink Diagrams}\label{sec:simulink}
...
\begin{figure}[htb]
	\centering
		\includegraphics[width = \textwidth]{figures/template/simulink.pdf}
